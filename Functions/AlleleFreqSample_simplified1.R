...
# General description:
#
#   This is a simplifed version of a function calculates the log probability of the count value
...
AlleleFreqSample_simplified1 <- function(k, s, N, SampleSize = 2504, DetectProb = 1,
