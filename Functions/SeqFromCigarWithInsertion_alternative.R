...
SeqFromCigarWithInsertion_alternative <- function(CigarString, Seq){
  ...
  # Loop to collect insertions
  InsList <- lapply(which(blnI), function(x){SeqV[idxSeqStart[x]:idxSeqEnd[x]]})
