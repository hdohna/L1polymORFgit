...
#   fragments) and determines wether fragment length is related to difference
#   from consensus

# Input:
#
#    L1HS_L100_withConsensus.fas: fasta file with all L1 sequences
#   
...
# Files and folders
AlignFileName <- "D:/L1polymORF/Data/L1HS_L100_withConsensus.fas"
...
DistL1 <- dist.dna(L1HSAlign, model = "raw")
sum(is.na(DistL1))
sum(!is.na(DistL1))
