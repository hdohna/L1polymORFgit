...
CreateDisplayPdf('D:/L1polymORF/Figures/PropInGeneVsInsLength_UCSC.pdf',
...
writeLines(as.character(GeneGR_All@elementMetadata@listData$proteinID),
           con = "D:/L1polymORF/Data/L1IntersectGeneIDs_All_UCSC")
writeLines(as.character(GeneGR_SameStrand@elementMetadata@listData$proteinID),
           con = "D:/L1polymORF/Data/L1IntersectGeneIDs_SameStrand_UCSC")
...
# Membrane
GeneTable <- data.frame(UniProtID = GeneGR@elementMetadata@listData$proteinID,
                        GeneLength = log10(width(GeneGR)),
                        GeneLength_untrans = width(GeneGR),
                        L1Count = GeneOLCount,
                        L1Count_ref = GeneOLCount_ref,
                        L1NegSelectCount = GeneOLNegSelectCount,
                        L1PosSelectCount = GeneOLPosSelectCount,
                        idxGeneGR = 1:length(GeneGR))
GeneTable$blnMHC <- overlapsAny(GeneGR, MHC_GR, ignore.strand = T)
...
write.csv(cbind(Sum_GLM_OLCount$coefficients, Padj),
          "D:/L1polymORF/Data/AnnoTermPValues_UCSC.csv")
...
# selected L1
fisher.test(GeneTable$Glycoprotein | GeneTable$Fibronect, GeneTable$L1NegSelectCount)
...
CreateDisplayPdf('D:/L1polymORF/Figures/NrInsVsGeneLength_UCSC.pdf',
                 PdfProgramPath = '"C:\\Program Files (x86)\\Adobe\\Reader 11.0\\Reader\\AcroRd32"',
                 height = 5, width = 5)
jpeg(file = "D:/L1polymORF/Figures/NrInsVsGeneLength_UCSC.jpeg")
plot(log10(width(GeneGR)),  GeneOLCount, col = PCol, pch = 16,
     xaxt = "n",
     xlab = "Gene length [bp]", 
     ylab = "Number of L1 insertions per gene")
...
lines(GeneTable$GeneLength_untrans[GeneLOrder], 
      GLM_OLCount_L$fitted.values[GeneLOrder], col = "red")
CreateDisplayPdf('D:/L1polymORF/Figures/NrInsVsGeneLength_untrans_UCSC.pdf',
                 PdfProgramPath = '"C:\\Program Files (x86)\\Adobe\\Reader 11.0\\Reader\\AcroRd32"',
                 height = 5, width = 5)
