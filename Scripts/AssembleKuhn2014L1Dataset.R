...
L1base    <- read.csv("D:/OneDrive - American University of Beirut/L1polymORF/Data/L1baseCharite.csv")
...
# Read in eul1db data
Families    <- read.delim("D:/OneDrive - American University of Beirut/L1polymORF/Data/eul1db_Family.txt", skip = 5)
Individuals <- read.delim("D:/OneDrive - American University of Beirut/L1polymORF/Data/eul1db_Individuals.txt", skip = 5)
Methods     <- read.delim("D:/OneDrive - American University of Beirut/L1polymORF/Data/eul1db_Methods.txt", skip = 5)
Studies     <- read.delim("D:/OneDrive - American University of Beirut/L1polymORF/Data/eul1db_Study.txt", skip = 5)
MRIP        <- read.delim("D:/OneDrive - American University of Beirut/L1polymORF/Data/eul1db_MRIP.txt", skip = 5)
SRIP        <- read.delim("D:/OneDrive - American University of Beirut/L1polymORF/Data/eul1db_SRIP.txt", skip = 5)
...
L1Kuhn2014    <- read.csv("D:/OneDrive - American University of Beirut/L1polymORF/Data/Kuhn2014PNAS_TableS2.csv")
L1Kuhn2014_GR <- makeGRangesFromDataFrame(L1Kuhn2014)

# Read in table for reference genome
L1Ref    <- read.csv("D:/OneDrive - American University of Beirut/L1polymORF/Data/repeatsHg19_L1HS.csv")
...
##############
# Add info from 1000 Genomes and MRIP
##############
