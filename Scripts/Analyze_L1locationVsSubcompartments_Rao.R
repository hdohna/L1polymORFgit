# The following script reads in a a bed file of subcompartments and determines 
# whether full-length L1 are overrepresented in a particular compartment
...
SubCTable <- read.table("D:/L1polymORF/Data/GSE63525_GM12878_subcompartments.bed",
   col.names = c("chrom", "start", "end", "SubC", "sign", "dot", "start2", 
                 "end2", "Nr"))
